<?php
// HTTP
define('HTTP_CATALOG', 'http://shopping-store.epizy.com/'); // Leave ended trailing slash with your domain.
define('HTTP_SERVER', 'http://shopping-store.epizy.com/admin/');
define('HTTP_IMAGE', 'http://shopping-store.epizy.com/image/');

// HTTPS
define('HTTPS_SERVER', 'https://shopping-store.epizy.com/admin/');
define('HTTPS_CATALOG', 'https://shopping-store.epizy.com/');
...
//define('DIR_CATALOG', ''); // Full server path to your catalog folder wth ended front-slash.
